...
/// encoding: x_1, x_0, y_1, y_0 (each big-endian).
...
/// Trusted setup point `[s]_2`, the second fixed G2 point in the pairing.
/// This is not the negated generator. These bytes also match the BB5 verifier.
///
/// Provenance: extracted from Barretenberg v0.82.2
/// `barretenberg/cpp/src/barretenberg/dsl/acir_proofs/honk_contract.hpp`
...
/// Multi-scalar multiplication on G1: sum s_i*C_i
///
